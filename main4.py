...
for x in range(100,800,150): #I did change them, and it changed how many overlapped, but the assignment says to play with them so I assume I'm not supposed to keep those changes.
